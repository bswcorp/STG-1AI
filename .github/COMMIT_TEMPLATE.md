docs(branding): integrate STG-AI logo & style

- Added STG-AI logo to assets/ folder
- Replaced old README.md with new canonical version
- Created dashboard/index.html with STG-AI branding
- Added BRANDING_GUIDE.md for official style references
- Configured branding-sync workflow to auto-rebuild dashboards
